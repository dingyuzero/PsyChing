...
const Layout = () => {
  ...
  const versionNote =
    language === 'zh'
      ? 'Psyching V2.0.1 含“人生回溯”与“未来指引”功能，当前为测试版本，信效度与题目参数将在后续实证阶段继续验证与微调。'
      : 'Psyching V2.0.1 includes Life Review and Future Guide. This is a testing version, and reliability, validity, and item parameters will be further validated and tuned in a later empirical phase.';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="border-b border-slate-200 bg-gradient-to-r from-amber-50 via-white to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <p className="text-xs sm:text-sm text-slate-600 text-center leading-relaxed">{versionNote}</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-slate-600">
            ...
            <p className="text-xs mt-2 text-slate-500">
              {language === 'zh'
                ? '仅供娱乐和自我认知参考，不构成专业心理咨询建议'
                : 'For entertainment and self-awareness only, not professional psychological advice'}
            </p>
          </div>
        </div>
      </footer>
