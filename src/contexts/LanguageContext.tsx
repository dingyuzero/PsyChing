...
const translations = {
  zh: {
    ...
    resultPage: {
      ...
      understood: '我明白了',
      yijingHexagramConcepts: '易经卦象概念',
      personalityTestMeaning: '人格测试意义',
      practicalGuidance: '实用指导',
      interpersonalRelations: '人际关系',
      interpersonalRelationsDesc: '在人际交往中，尝试展现综卦和错卦的积极特质。',
      potentialPersonality: '潜在人格',
      hexagramExplanationTitle: '卦象解释说明',
      // 游戏角色相关翻译
      gameCharacter: '游戏角色',
      characterProfile: '角色档案',
      characterRole: '职业',
      characterWeapon: '武器',
      characterCombination: '角色组合',
      characterDescription: '角色描述',
      roleFromInnerMotivation: '内在动机决定职业',
      weaponFromOuterBehavior: '外在行为决定武器',
      characterApplications: '应用场景',
      gameDesign: '游戏设计',
      characterCreation: '角色创建',
      teamBuilding: '团队建设',
      personalityVisualization: '人格可视化',
      elements: {
         metal: '金',
         wood: '木',
         water: '水',
  ...
  en: {
    ...
    resultPage: {
      ...
      yijingHexagramConcepts: 'I Ching Hexagram Concepts',
      personalityTestMeaning: 'Personality Test Meaning',
      practicalGuidance: 'Practical Guidance',
      interpersonalRelations: 'Interpersonal Relations',
      interpersonalRelationsDesc: 'In interpersonal interactions, try to display the positive traits of Zong and Cuo hexagrams.',
      potentialPersonality: 'Potential Personality',
      hexagramExplanationTitle: 'Hexagram Explanation',
      // Game character related translations
      gameCharacter: 'Game Character',
      characterProfile: 'Character Profile',
      characterRole: 'Role',
      characterWeapon: 'Weapon',
      characterCombination: 'Character Combination',
      characterDescription: 'Character Description',
      roleFromInnerMotivation: 'Inner motivation determines role',
      weaponFromOuterBehavior: 'Outer behavior determines weapon',
      characterApplications: 'Application Scenarios',
      gameDesign: 'Game Design',
      characterCreation: 'Character Creation',
      teamBuilding: 'Team Building',
      personalityVisualization: 'Personality Visualization',
      elements: {
        metal: 'Metal',
        wood: 'Wood',
        water: 'Water',
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    // 默认使用中文，只有用户明确选择英文时才切换
    const preferences = getUserPreferences();
    // 如果localStorage中没有语言设置，或者设置为英文但用户没有主动选择，则使用中文
    if (preferences.language === 'en' && preferences.userSelectedLanguage) {
      setLanguageState('en');
    } else {
      // 确保默认为中文，并清除可能存在的英文设置
      setLanguageState('zh');
      updateUserPreferences({ language: 'zh', userSelectedLanguage: false });
    }
  }, []);
